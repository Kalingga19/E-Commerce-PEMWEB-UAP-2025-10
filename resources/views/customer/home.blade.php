    ...
    <div class="min-h-screen bg-gray-50">
        ...
        <section class="relative bg-gradient-to-r from-blue-600 to-indigo-700 text-white overflow-hidden">
            ...
            <div class="relative h-[500px] md:h-[600px]">
                <!-- Carousel Items -->
                <div id="carousel-item-1" class="absolute inset-0 h-[600px] w-full transition-opacity duration-1000 ease-in-out opacity-100">
                    ...
                    <div class="container mx-auto px-4 h-full flex items-center relative z-20">
                        <div class="max-w-2xl">
                            <h1 class="text-4xl md:text-6xl font-bold mb-4 animate-fade-in">Flash Sale<br>Special Offers</h1>
                            <p class="text-xl mb-8 text-blue-100">
                                Diskon hingga 70% untuk produk pilihan. Waktu terbatas!
                            </p>
                            <a href="#products"
                            class="inline-block bg-white text-blue-600 px-8 py-4 rounded-xl font-bold hover:bg-gray-100 
                ...
                <div id="carousel-item-1" class="absolute inset-0 h-[600px] w-full transition-opacity duration-1000 ease-in-out opacity-100">
                    ...
                    <div class="container mx-auto px-4 h-full flex items-center relative z-20">
                        <div class="max-w-2xl">
                            <h1 class="text-4xl md:text-6xl font-bold mb-4 animate-fade-in">New Arrivals<br>2025 Collection</h1>
                            <p class="text-xl mb-8 text-blue-100">
                ...
                <div id="carousel-item-1" class="absolute inset-0 h-[600px] w-full transition-opacity duration-1000 ease-in-out opacity-100">
                    ...
                    <div class="container mx-auto px-4 h-full flex items-center relative z-20">
                        <div class="max-w-2xl">
                            <h1 class="text-4xl md:text-6xl font-bold mb-4 animate-fade-in">Free Shipping<br>Minimal Purchase</h1>
                            <p class="text-xl mb-8 text-blue-100">
                ...
                <!-- Carousel Controls -->
                <button onclick="prevSlide()" class="absolute left-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm p-3 rounded-full z-30 transition-all duration-300">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 19l-7-7 7-7"></path>
                    </svg>
                </button>
                <button onclick="nextSlide()" class="absolute right-4 top-1/2 -translate-y-1/2 bg-white/20 hover:bg-white/30 backdrop-blur-sm p-3 rounded-full z-30 transition-all duration-300">
                    <svg class="w-6 h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="relative overflow-hidden rounded-2xl group">
                        <img src="https://images.unsplash.com/photo-1542291026-7eec264c27ff?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                            class="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-500" alt="Fashion">
                    ...
                    <div class="relative overflow-hidden rounded-2xl group">
                        <img src="https://images.unsplash.com/photo-1526170375885-4d8ecf77b99f?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                            class="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-500" alt="Electronics">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                        <div class="absolute bottom-6 left-6 text-white">
                    ...
                    <div class="relative overflow-hidden rounded-2xl group">
                        <img src="https://images.unsplash.com/photo-1581094794329-c8112a89af12?ixlib=rb-1.2.1&auto=format&fit=crop&w=800&q=80" 
                            class="w-full h-48 object-cover group-hover:scale-110 transition-transform duration-500" alt="Home Appliances">
                        <div class="absolute inset-0 bg-gradient-to-t from-black/60 to-transparent"></div>
                        <div class="absolute bottom-6 left-6 text-white">
            ...
            <div class="container mx-auto px-4">
                ...
                <div class="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-6 gap-4">
                    ...
                    <a href="{{ route('category.filter', $category->slug) }}" class="group">
                        <div class="bg-white p-6 rounded-2xl shadow-sm hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 text-center">
                            <div class="w-16 h-16 bg-gradient-to-r from-blue-100 to-indigo-100 rounded-2xl flex items-center justify-center mx-auto mb-4 group-hover:scale-110 transition-transform duration-300">
                                <svg class="w-8 h-8 text-blue-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 7h.01M7 3h5c.512 0 1.024.195 1.414.586l7 7a2 2 0 010 2.828l-7 7a2 2 0 01-2.828 0l-7-7A1.994 1.994 0 013 12V7a4 4 0 014-4z" />
                                </svg>
                            </div>
                            <h3 class="font-semibold text-gray-800 group-hover:text-blue-600 transition-colors duration-300">{{ $category->name }}</h3>
        ...
        <section id="products" class="py-16 bg-white">
            <div class="container mx-auto px-4">
                        ...
                        <div class="relative overflow-hidden bg-gradient-to-br from-gray-50 to-gray-100">
                            ...
                            <div class="absolute top-4 right-4 flex flex-col gap-2">
                                <button class="p-3 bg-white/90 backdrop-blur-sm rounded-2xl hover:bg-white hover:scale-110 hover:shadow-lg transition-all duration-300 group/wishlist">
                                    <svg class="w-5 h-5 text-gray-600 group-hover/wishlist:text-red-500 transition-colors duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        ...
                        <div class="p-6">
                            ...
                            @csrf
                                ...
                                <button type="submit" class="w-full py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl shadow-md hover:shadow-lg transition-all duration-300 transform hover:-translate-y-0.5 active:scale-95 flex items-center justify-center group/button">
                                    <svg class="w-5 h-5 mr-3 group-hover/button:scale-110 transition-transform duration-300" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                ...
                <div class="text-center mt-12">
                    <a href="{{ route('home') }}" class="inline-block px-8 py-4 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-1">
                        Lihat Semua Produk
                    </a>
                </div>
            </div>
        ...
        <section class="py-16 bg-gray-50">
            <div class="container mx-auto px-4">
                <div class="text-center mb-12">
                    ...
                    <p class="text-gray-600 max-w-2xl mx-auto">Kami berkomitmen memberikan pengalaman belanja terbaik untuk Anda</p>
                </div>
                ...
                <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                    ...
                    <div class="text-center">
                        <div class="w-20 h-20 bg-gradient-to-r from-green-100 to-emerald-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
                    ...
                    <div class="text-center">
                        <div class="w-20 h-20 bg-gradient-to-r from-orange-100 to-red-100 rounded-2xl flex items-center justify-center mx-auto mb-6">
        ...
        <section class="py-16 bg-gradient-to-r from-blue-600 to-indigo-700 text-white">
            <div class="container mx-auto px-4 text-center">
                ...
                <p class="text-blue-100 mb-8 max-w-2xl mx-auto">Daftarkan email Anda untuk mendapatkan notifikasi promo eksklusif dan penawaran spesial</p>
