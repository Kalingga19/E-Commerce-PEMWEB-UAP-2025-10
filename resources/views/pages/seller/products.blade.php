<!-- resources/views/pages/seller/products.blade.php -->
@extends('layouts.app')

@section('title', 'Manajemen Produk - Laravel E-Commerce')
        ...
        <div class="card mb-4">
            ...
            <div class="card-body">
                ...
                <div class="text-center py-5">
                    ...
                    <p class="mb-0">Mulai dengan menambahkan produk pertama Anda</p>
