    ...
    <div class="py-8 px-4 sm:px-6 lg:px-8">
        <div class="max-w-4xl mx-auto">
            ...
            <div class="bg-white rounded-2xl shadow-xl border border-gray-200 overflow-hidden">
                ...
                <form method="POST" action="{{ route('seller.products.update', $product) }}" class="px-8 py-8">
                    @csrf
                    @method('PUT')
                    ...
                    <div class="p-6">
                        ...
                        <div>
                            ...
                            <div class="grid grid-cols-2 sm:grid-cols-4 gap-4">
                                <div class="relative border-2 border-dashed border-gray-200 rounded-xl h-32 flex items-center justify-center bg-gray-50">
                                ...
                                @for($i = 0; $i < 3; $i++)
                                <div class="border-2 border-dashed border-gray-200 rounded-xl h-32 flex items-center justify-center bg-gray-50">
                                    <div class="text-center">
                                        <svg class="w-8 h-8 text-gray-400 mx-auto mb-2" fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
                                            <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M4 16l4.586-4.586a2 2 0 012.828 0L16 16m-2-2l1.586-1.586a2 2 0 012.828 0L20 14m-6-6h.01M6 20h12a2 2 0 002-2V6a2 2 0 00-2-2H6a2 2 0 00-2 2v12a2 2 0 002 2z"></path>
                                        </svg>
                                        <span class="text-xs text-gray-500">Gambar {{ $i + 1 }}</span>
                                    </div>
                                </div>
                                @endfor
                            </div>
                            <p class="mt-4 text-sm text-gray-500">Minimal 1 gambar, maksimal 8 gambar. Gambar pertama akan menjadi thumbnail.</p>
                        </div>
                    </div>
                </div>
